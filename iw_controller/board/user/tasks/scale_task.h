...
#define  SCALE_TASK_RESULT_SUCCESS            0xAA
#define  SCALE_TASK_RESULT_FAIL               0xBB

enum
{
    SCALE_TASK_MSG_TYPE_QUERY_NET_WEIGHT,
    ...
    SCALE_TASK_MSG_TYPE_RSP_QUERY_NET_WEIGHT,
